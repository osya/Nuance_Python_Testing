...
params = urllib.urlencode({'appId': args.app_id, 'appKey': args.app_key, 'id': randomID, 'ttsLang': ttsLang, 'voice': voice})
...
with open('tts_%s' % time.strftime("%H_%M_%S") + '.wav', 'wb') as wav_file:
